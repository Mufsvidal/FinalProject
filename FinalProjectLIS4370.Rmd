...
```
# Introduction
This explores the medellin dataset and finds the maximum, minimum and average monthly temperatures in Medellin, Colombia. The goal is to compute and visualize the trends. 
...
#### Find the Max,Minimum and Average temps 
```{r finding max,min and avg}
